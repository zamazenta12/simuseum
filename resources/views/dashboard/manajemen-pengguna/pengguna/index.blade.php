    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <a href="/dashboard-pengguna/create" class="btn text-light btn-sm rounded-0 btn-tambah"
                    style="background-color: #20c997   "><i class="fas fa-plus"></i> Tambah Pengguna</a>
            </div>
            <div class="card-body">
                            ...
                            @endif
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if ($item->role == 'sekolah')
                                            <a href="{{ route('pengguna.print', $item->id) }}"
                                                class="btn btn-primary btn-sm rounded-0"><i class="fa fa-print"></i>
                                                Print</a>
                                        @endif
                                        <a href="/dashboard-pengguna/{{ $item->id }}/edit"
                                            class="btn btn-success btn-sm rounded-0"><i class="fa fa-edit"></i> Ubah</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <form action="/dashboard-pengguna/{{ $item->id }}" method="POST"
